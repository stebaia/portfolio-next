  ...
  return (
    <main className={`flex min-h-screen flex-col bg-[#121212]`}>
      ...
      <div className="container mt-24  mx-auto px-12 py-12">
        {/*  */}
        <TextInfoSection paragraph="Amo sviluppare App e Siti Web e mi diverto a farli nella maniera migliore e più funzionale possibile." imageUrl={"/images/logo.png"}/>
      <Services/>
      </div>
