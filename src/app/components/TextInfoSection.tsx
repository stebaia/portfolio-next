...
export default function TextInfoSection({ paragraph, imageUrl }: { paragraph: string, imageUrl: string }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center pt-20 pb-60">
      {/* Image Section */}
      ...
      <div className="w-full md:w-1/2 flex justify-center md:justify-start">
        <p
          ref={container}
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-relaxed font-bold opacity-90 pb-60 text-center md:text-left"
        >
          {
            words.map((word, i) => {
